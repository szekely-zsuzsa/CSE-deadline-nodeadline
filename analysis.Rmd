...
Bf(sd = 21.792933,
   ...
   dfdata = 54 - 1,
   meanoftheory = 0,
   sdtheory = 92.52, # based on Weissman et al. 2014
   dftheory = 10^10,
   tail = 1)
```
...
Calculating the BF for dl accuracy CE.

```{r}
Bf(sd = 0.0201650443,
   obtained = 0.1198930103,
   dfdata = 54 - 1,
   meanoftheory = 0,
   sdtheory = 0.0093, # based on Weissman et al. 2014
   dftheory = 10^10,
   tail = 1)
```
...
## save plot
ggsave("figures/deadline/panic_blocks_violin_hun.png", width = 18, height = 8, plot = last_plot())
...
Calculating the BF for nodl rt CE.
...
Calculating the BF for nodl accuracy CE.

```{r}
Bf(sd = 0.01410812,
   obtained = 0.029669408,
   dfdata = 63 - 1,
   meanoftheory = 0,
   sdtheory = 0.0093,
   dftheory = 10^10,
